...
/* define if you have the id3lib library */
/* #undef FLAC__HAS_ID3LIB */
...
/* define to major version number of id3lib */
/* #undef ID3LIB_MAJOR */

/* define to minor version number of id3lib */
/* #undef ID3LIB_MINOR */

/* define to patch level of id3lib */
/* #undef ID3LIB_PATCH */
